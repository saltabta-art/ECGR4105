...
# Load diabetes CSV (real file)

df = pd.read_csv("diabetes.csv")  # rename to your file
...
for ep in range(epochs):
    ...
    print(f"Epoch {ep+1} - Train Loss {train_losses[-1]:.4f} - Val Loss {val_losses[-1]:.4f}")
